...
def main():
    ...
    while True:
        ...
        def kawaii():
            ...
            # webbrowser.open('/mejiro_fes/Happy_Halloween.txt')
            # subprocess.Popen('/mejiro_fes/Happy_Halloween.txt',shell=True)
            #open('/Users/jwumath/Git/mejiro_fes/Happy_Halloween.txt')
            #os.open('/Users/jwumath/Git/mejiro_fes/Happy_Halloween.txt')
